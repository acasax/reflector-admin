export const DEFAULT_MESSAGE_REQUIRED = "Obavezno polje";
export const DEFAULT_MESSAGE_MAX_VALUE = "Maksimalna vrednost je {max}";
export const DEFAULT_MESSAGE_MIN_LENGTH = "Minimalna vrednost je {min}";
export const DEFAULT_MESSAGE_NOT_EMPTY = "Polje može biti prazno";
export const DEFAULT_MESSAGE_ONLY_NUMBERS = "Samo brojevi";
export const DEFAULT_MESSAGE_REGEX = "Regex nije prošla";
export const DEFAULT_MESSAGE_NOT_SAME = "Polja se moraju podudarati";
...
export const checkRegex = ({ message, regex }: IValidatorRegularExpression) => (value?: string): backType => {
  return !isDefined(value) ? false : (regex.test(value as string) ? false : (message ? message : DEFAULT_MESSAGE_REGEX));
};
